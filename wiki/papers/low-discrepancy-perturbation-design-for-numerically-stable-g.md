...
**Venue**: IEEE Control Systems Letters, 2026  |  **Category**: [[topics/control|Control]]  |  **Link**: <https://ieeexplore.ieee.org/abstract/document/11589304/>

**Authors**: CJ Cortes, I Monteiro, [[researchers/samuel-coogan|Samuel Coogan]], M Gamarra, M Thitsa
...
We present a numerically stable gradient estimation algorithm for unknown objective functions in feedback-based optimization settings. Unlike classical extremum seeking control, which recovers gradient components sequentially via distinct …
...
- [[sources/coogan-0705-eml|coogan_0705.eml]]
