# [PDF] Training and Evaluating Diffusion Policies with Long Context Lengths

**Venue**: arXiv preprint arXiv …, 2026  |  **Category**: [[topics/ml|Ml]]

**Authors**: A Agarwal, A Wei, T Kargin, M Zeng, C Becker, AK Dayi, …

**Followed researchers**: [[researchers/russ-tedrake|Russ Tedrake]]

**Topics**: [[topics/diffusion-models|Diffusion Models]], [[topics/imitation-learning|Imitation Learning]]

---

## Summary

Imitation learning has enabled highly-capable visuomotor policies, but the role of long temporal context in diffusion policies remains underexplored …
...
- [[sources/tedrake-0619-eml|tedrake_0619.eml]]
